...
class TestZipdemographicsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ZipdemographicsAPIClient(self.api_key)

    @patch('apiverve_zipdemographics.apiClient.requests.get')
