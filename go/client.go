...
const (
	baseURL        = "https://api.apiverve.com/v1/zipdemographics"
	defaultTimeout = 30 * time.Second
)

// Client is the ZIP Demographics API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new ZIP Demographics API client.
...
// Execute makes a request to the ZIP Demographics API with typed parameters.
//
